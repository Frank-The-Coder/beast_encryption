...
static void bit_xor(const unsigned char *bits1, const unsigned char *bits2, unsigned
   char *bitsx, int size) {
...
static void bit_rot_left(unsigned char *bits, int size, int count) {
...
static void DES_encipher(const unsigned char *plaintext, unsigned char *ciphertext,
...
static void DES_decipher(const unsigned char *ciphertext, unsigned char *plaintext,
   const unsigned char *key) {
